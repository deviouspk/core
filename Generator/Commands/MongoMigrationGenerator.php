 ...
 */
class MongoMigrationGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'apiato:generate:migration:mongo';
     ...
     * @var string
     */
    protected $description = 'Create an "empty" mongo migration file for a Container';
     ...
     * @var  string
     */
    protected $stubName = 'mongomigration.stub';
    ...
    {
        return 'create_' . Str::lower($this->containerName) . '_collection';
    }
